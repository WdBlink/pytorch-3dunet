...
class DataSubSet:
    ...
    def __init__(self, directory_map, data_set_type=None):
...
class DataSet(object):
    ...
    def __init__(self, data_set_dir=None, brats_root=None, year=None):
        ...
        self._2019_hgg_dir_map_cache = None
        self._2019_lgg_dir_map_cache = None
...
#         return self._validation_survival_csv_cached
    ...
    @property
    def _2019_lgg_dir_map(self):
        if self._2019_lgg_dir_map_cache is None:
            self._2019_lgg_dir_map_cache = self._directory_map(self._2019_lgg_dir)
        return self._2019_lgg_dir_map_cache

    @property
    def _2019_hgg_dir_map(self):
        if self._2019_hgg_dir_map_cache is None:
            self._2019_hgg_dir_map_cache = self._directory_map(self._2019_hgg_dir)
        return self._2019_hgg_dir_map_cache
